...
### Added
- Initial release. Tools: `wb_indicator`, `wb_search_indicator`, `fred_series`, `fred_search_series`, `compare_countries`, `economic_calendar`.
- Wraps World Bank v2 API + FRED.
- World Bank pagination handled (per_page=200, multi-page fetch up to 5000 points).
- ISO 3166-1 alpha-3 country code normalization (accepts alpha-2, alpha-3, common names).
